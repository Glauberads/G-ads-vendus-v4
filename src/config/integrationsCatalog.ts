  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'mercadopago',
        name: 'Mercado Pago',
        description: 'PIX Direto com credenciais da sua conta Mercado Pago',
        icon: Wallet,
        color: 'bg-yellow-500/10 text-yellow-500',
        logoSrc: '/integrations/logos/mercadopago.svg',
        configKey: 'cakto',
        keywords: ['mercado pago', 'mp', 'pix', 'gateway', 'checkout'],
      },
      {
        id: 'asaas',
        name: 'Asaas',
        description: 'PIX Direto com credenciais da sua conta Asaas',
        icon: Banknote,
        color: 'bg-emerald-500/10 text-emerald-500',
        logoSrc: '/integrations/logos/asaas.svg',
        configKey: 'cakto',
        keywords: ['asaas', 'pix', 'gateway', 'checkout'],
      },
      {
        id: 'pagarme',
        name: 'Pagar.me',
