...
export default function PublicFunnel() {
  ...
  const { data: funnel, isLoading, error } = useFunnelBySlug(slug, 'form');
  ...
  const primaryColor = theme?.primary_color || '#00C48C';
  const bgColor = theme?.background_color || '#080F0E';
  ...
  return (
    <div
      ...
      style={{
        ...
        fontFamily: theme?.font_family ? `'${theme.font_family}', system-ui, sans-serif` : "'Inter', system-ui, sans-serif",
      }}
    >
