...
import { FormBlockType, BLOCK_CONFIGS, BlockConfig } from '@/types/forms';
...
export function FormBlockPalette({ onDragStart, onBlockClick }: FormBlockPaletteProps) {
  const categories = ['screen', 'input', 'selection', 'logic', 'advanced'];
