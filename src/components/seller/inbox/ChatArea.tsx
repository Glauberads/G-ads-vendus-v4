...
export function ChatArea({
  ...
  return (
    <div className="flex-1 flex flex-col bg-background min-w-0 overflow-hidden">
      ...
      {!isMobile && (
      <div
        className="h-16 px-3 sm:px-4 border-b border-border flex items-center justify-between bg-background relative gap-2 min-w-0"
      >
      ...
      {needsAccept && onAcceptTicket ? (
        ...
        <div className="border-t border-border bg-amber-50 dark:bg-amber-950/30 px-4 py-3 flex items-center justify-between gap-3">
