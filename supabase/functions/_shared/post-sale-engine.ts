...
export async function runPostSaleActions(
  ...
  // 1) Always run tag automations (already handled elsewhere via apply_tag_automations)
  //    but call it here too so single-source-of-truth holds even for new platforms.
